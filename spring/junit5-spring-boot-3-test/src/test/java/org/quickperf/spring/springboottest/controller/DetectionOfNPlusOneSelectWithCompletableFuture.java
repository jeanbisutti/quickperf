...
public class DetectionOfNPlusOneSelectWithCompletableFuture {
    ...
    @ExpectSelect(1)
    @Test
    void should_detect_n_plus_one_select_via_completable_future_endpoint() {

        // GIVEN
        String url = "http://localhost:" + port + "/cf/players";
